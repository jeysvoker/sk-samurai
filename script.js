...
const translations = {
  ru: {
    ...
    chat: {
      ...
      paidPrice: "Цена 30$ месяц",
      payBtn: "ОПЛАТИТЬ — USDT / TRC20",
      payTitle: "Для оплаты криптой совершите перевод 30$ по реквизитам ниже",
  ...
  uk: {
    ...
    chat: {
      ...
      paidPrice: "Ціна 30$ місяць",
      payBtn: "ОПЛАТИТИ — USDT / TRC20",
      payTitle: "Для оплати криптою здійсніть переказ 30$ за реквізитами нижче",
  ...
  en: {
    ...
    chat: {
      ...
      paidPrice: "Price $30 / month",
      payBtn: "PAY — USDT / TRC20",
      payTitle: "To pay with crypto, transfer $30 to the details below",
