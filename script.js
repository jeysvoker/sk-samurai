...
const translations = {
  ru: {
    ...
    chat: {
      ...
      pill3: "Работа с личным депозитом<br />Работа с проп-счётом",
      pill4: "Обучение с нуля: 5 структурированных уроков, сопровождение от опытных участников закрытого чата",
      pill5: "Вечерний стрим по итогам недели (каждую пятницу) — разбор ошибок участников",
      pill6: "Отдельный чат общения среди участников, обмен мнением, вопросы по торговле",
      ...
      refIntroText: "Получите пожизненный доступ по партнёрской ссылке с депозитом от 300$",
      ...
      refStep4: "Пополни торговый счёт от 300$",
      ...
      paidPrice: "Цена 55$ месяц",
      payBtn: "ОПЛАТИТЬ — USDT / TRC20",
      payTitle: "Для оплаты криптой совершите перевод 55$ по реквизитам ниже",
  ...
  uk: {
    ...
    chat: {
      ...
      pill3: "Робота з особистим депозитом<br />Робота з проп-рахунком",
      pill4: "Навчання з нуля: 5 структурованих уроків, супровід від досвідчених учасників закритого чату",
      pill5: "Вечірній стрим за підсумками тижня (щоп’ятниці) — розбір помилок учасників",
      pill6: "Окремий чат спілкування між учасниками, обмін думками, запитання щодо торгівлі",
      ...
      refIntroText: "Отримайте довічний доступ за партнерським посиланням із депозитом від 300$",
      ...
      refStep4: "Поповни торговий рахунок від 300$",
      ...
      paidPrice: "Ціна 55$ місяць",
      payBtn: "ОПЛАТИТИ — USDT / TRC20",
      payTitle: "Для оплати криптою здійсніть переказ 55$ за реквізитами нижче",
  ...
  en: {
    ...
    chat: {
      ...
      pill3: "Working with a personal deposit<br />Working with a prop account",
      pill4: "Training from scratch: 5 structured lessons with support from experienced private-chat members",
      pill5: "Weekly evening stream every Friday — review of participants’ mistakes",
      pill6: "A separate members chat for communication, idea exchange, and trading questions",
      ...
      refIntroText: "Get lifetime access via the partner link with a deposit from $300",
      ...
      refStep4: "Fund your trading account with $300+",
      ...
      paidPrice: "Price $55 / month",
      payBtn: "PAY — USDT / TRC20",
      payTitle: "To pay with crypto, transfer $55 to the details below",
