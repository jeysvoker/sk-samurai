...
const translations = {
  ru: {
    ...
    chat: {
      ...
      refIntroText: "Получите пожизненный доступ по партнёрской ссылке с депозитом от 250$",
      ...
      refStep4: "Пополни торговый счёт от 250$",
  ...
  uk: {
    ...
    chat: {
      ...
      refIntroText: "Отримайте довічний доступ за партнерським посиланням із депозитом від 250$",
      ...
      refStep4: "Поповни торговий рахунок від 250$",
  ...
  en: {
    ...
    chat: {
      ...
      refIntroText: "Get lifetime access via the partner link with a deposit from $250",
      ...
      refStep4: "Fund your trading account with $250+",
